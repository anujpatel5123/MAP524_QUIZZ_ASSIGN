...
public class MainActivity extends AppCompatActivity {
    ...
    QuestionMgr questionBank = new QuestionMgr();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String selectedLanguage = LangHelpers.getLanguage(this);
        if (selectedLanguage.isEmpty()) {
            context = LangHelpers.setLocale(this, "");
        } else {
            context = LangHelpers.setLocale(this, selectedLanguage);
        }
        resources = context.getResources();
        totalquestions = PreferenceManager.getTotalQuestions(this, 0);
        totalCorrectAnswer = PreferenceManager.getTotalCorrectAnswers(this, 0);
...
//
    ...
    private void showResultDialog(String question) {
        ...
        builder.setTitle(resources.getString(R.string.result)).setMessage(resources.getString(R.string.your_result) + correctAnswers + resources.getString(R.string.out_of) + questions).setCancelable(false).setPositiveButton(resources.getString(R.string.save), (dialogInterface, i) -> {
            ...
            PreferenceManager.saveTotalQuestions(this, totalquestions);
            PreferenceManager.saveTotalCorrectAnswers(this, totalCorrectAnswer);
    ...
    private void showLanguageDialog() {
        ...
        TextView tvUrdu = dialogView.findViewById(R.id.tvGujarati);

        String selectedLanguage = LangHelpers.getLanguage(this);

        if (selectedLanguage.equals("gj")) {
            ...
            tvUrdu.setBackgroundColor(Color.TRANSPARENT);
            tvUrdu.setTextColor(Color.BLACK);
        }
    ...
    public void onLanguageSelected(View view) {
        ...
        context = LangHelpers.setLocale(this, selectedLanguage);
        resources = context.getResources();
        PreferenceManager.saveLanguage(this, selectedLanguage);
        recreate();
    }

    private void showAverageDialog() {
        int a = PreferenceManager.getTotalCorrectAnswers(this, 0);
        int b = PreferenceManager.getTotalQuestions(this, 0);

        ConvoUtil.showAlertDialog(this, null, resources.getString(R.string.message_average) + a + "/" + b, resources.getString(R.string.ok), resources.getString(R.string.cancel), new Runnable() {
            @Override
            public void run() {
            }
        }, new Runnable() {
    ...
    private void showResetConfirmationDialog() {
        PreferenceManager.deleteTotalCorrectAnswers(this);
        PreferenceManager.deleteTotalQuestions(this);
        totalquestions = PreferenceManager.getTotalQuestions(this, 0);
        totalCorrectAnswer = PreferenceManager.getTotalCorrectAnswers(this, 0);

        ConvoUtil.showAlertDialog(this, null, resources.getString(R.string.message_average) + totalCorrectAnswer + "/" + totalquestions, resources.getString(R.string.ok), resources.getString(R.string.cancel), new Runnable() {
            @Override
            public void run() {
